							...
							<table class="table table-bordered detail" id="dataTable" width="100%" cellspacing="0">
								<thead>
									<tr>
										...
										<th class="col-xs-5">Path Fitur</th>
								...
								<tbody>
									<?php foreach ($data['detail_fitur'] as $key => $d_val): ?>
										<tr data-iddet="<?php echo $d_val['id_detfitur']; ?>">
											<td>
												<input type="text" placeholder="No. Urut" id="no_urut" class="form-control text-right" data-tipe="integer" data-required="1" maxlength="3" value="<?php echo $d_val['no_urut']; ?>">
											</td>
											<td>
