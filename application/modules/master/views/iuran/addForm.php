		...
		<div class="col-xs-12 detailed no-padding">
			<form role="form" class="form-horizontal">
                ...
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="col-xs-12">
                        <input type="text" placeholder="Nominal (Rp.)" class="form-control text-right nominal" data-required="1" data-tipe="integer" maxlength="6">
                    </div>
                </div>
                ...
                <div class="col-xs-12">
                    <button id="btn-add" type="button" class="col-xs-12 pull-right btn btn-primary cursor-p" title="SAVE" onclick="i.save(this)"> 
