...
<head>
  ...
  <title><?php echo $title_menu; ?></title>
...
<body>
    ...
    <div class="bg-light-black" id="sidebar-wrapper" style="width: 17rem;">
      <div class="sidebar-heading">
        <a href="#">
          ...
          <b><?php echo $this->config->item('judul_aplikasi'); ?></b>
        </a>
      </div>
    ...
    <div id="page-content-wrapper">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom no-padding">
        ...
        <a id="menu-toggle" title="Hide Menu">
          <i class="fa fa-angle-left cursor-p left" hidden="true"></i> 
          <i class="fa fa-navicon cursor-p"></i> 
          <i class="fa fa-angle-right cursor-p right"></i>
        </a>

        <div class="title"><span class="control-label"><?php echo $title_menu; ?></span></div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <?php 
            ...
            $list_notif = $notif;
            $jml_notif = !empty($notif) ? count($notif) : 0;
            // $content['list_notif'] = $this->list_notif();
            // $content['jml_notif'] = count($this->list_notif());
          ?>

          <ul class="navbar-nav ml-auto mt-2 mt-lg-0 pull-left notify-row hide">
                    ...
                    <li class="dropdown-item no-padding cursor-p">
                      <a href="<?php echo $v_notif['path']; ?>" title="<?php echo $v_notif['nama_fitur'] . ' (' . $v_notif['next_state'] . ')' ; ?>">
                        ...
                        <!-- <div class="col-md-4 no-padding"> -->
                          <!-- <span class="col-md-4 italic text-right"><?php echo '(' . $status . ') ' . $v_notif['jumlah']; ?></span> -->
                        <!-- </div> -->
                      </a>
                    </li>
                  <?php endforeach ?>
          ...
          <!-- <div class="col-md-8 title"><span class="control-label"><?php echo $title_menu; ?></span></div> -->
          ...
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0 pull-right">
            ...
            <li id="header_notification_bar" class="nav-item dropdown">
              <span class="control-label" style="margin-right: 1rem;" ><?php echo $this->session->userdata()['detail_user']['nama_detuser']; ?></span>
              <?php
  ...
  <script>
    $("#menu-toggle").click(function(e) {
      ...
      // console.log( $('span.select2').prev('select').length );
      // if ( $('span.select2').prev('select').length > 0 ) {
      //   $.map( $('span.select2'), function( span ) {
      //     $(span).prev('select').select2();
      //   });
      // }
    });
