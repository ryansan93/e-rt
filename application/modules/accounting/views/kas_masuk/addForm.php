<div class="modal-header">
	<span class="modal-title"><b>Tambah Kas Masuk</b></span>
	...
	<div class="row detailed">
		...
		<div class="col-xs-12 detailed no-padding">
			<form role="form" class="form-horizontal">
                ...
                <div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
                    ...
                    <div class="col-xs-12">
						<label class="lampiran-contain-btn" style="margin-bottom: 0px;">
							<input style="display: none;" placeholder="Dokumen" class="file_lampiran no-check" type="file" onchange="km.showNameFile(this)" data-name="name" data-allowtypes="jpg|JPG|png|PNG|jpeg|JPEG" data-required="1">
                ...
                <div class="col-xs-12">
                    <button id="btn-add" type="button" class="col-xs-12 pull-right btn btn-primary cursor-p" title="SAVE" onclick="km.cekData(this)" data-jenis="save"> 
