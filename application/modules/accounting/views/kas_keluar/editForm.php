<div class="modal-header">
	<span class="modal-title"><b>Edit Kas Keluar</b></span>
	...
	<div class="row detailed">
		...
		<div class="col-xs-12 detailed no-padding">
			<form role="form" class="form-horizontal">
                ...
                <div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
                    ...
                    <div class="col-xs-12">
						<label class="lampiran-contain-btn" style="margin-bottom: 0px;">
							<input style="display: none;" placeholder="Dokumen" class="file_lampiran no-check" type="file" onchange="kk.showNameFile(this)" data-name="name" data-allowtypes="jpg|JPG|png|PNG|jpeg|JPEG">
                ...
                <div class="col-xs-12">
                    <button id="btn-add" type="button" class="col-xs-12 pull-right btn btn-primary cursor-p" title="EDIT" onclick="kk.cekData(this)" data-jenis="edit" data-kode="<?php echo $data['kode']; ?>"> 
