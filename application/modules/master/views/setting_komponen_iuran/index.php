		...
		<form role="form" class="form-horizontal">
			<div class="col-xs-12 no-padding">
				<?php if ( $akses['a_submit'] == 1 ): ?>
					<button id="btn-add" type="button" class="col-xs-12 btn btn-primary cursor-p" title="ADD" onclick="ski.addForm(this)"> 
				...
				<table class="table table-bordered table-hover tblRiwayat" id="dataTable" width="100%" cellspacing="0">
					<thead>
						<tr>
							...
							<th class="col-xs-2">Kode Iuran</th>
							<th class="col-xs-7">Nominal</th>
