...
class Event extends Public_Controller {
  ...
  */
  ...
  public function save($model, $message = null, $id = null, $keterangan = null, $id_verifikasi = null, $json = null, $kode_import_data = null) {
    ...
    $m_log->kode_import_data = $kode_import_data;
    $m_log->save ();

    return $m_log;
  }

  public function update($model, $message = null, $id = null, $keterangan = null, $id_verifikasi = null, $json = null, $kode_import_data = null) {
    $m_log = new \Model\Storage\LogTables_model();
    $now = $m_log->getDate();
    $m_log->tbl_name = $model->getTable();
    $m_log->tbl_id = !empty($id) ? $id : $model->id;
  ...
  public function delete($model, $message = null, $id = null, $keterangan = null, $id_verifikasi = null, $json = null, $kode_import_data = null) {
    $m_log = new \Model\Storage\LogTables_model();
    $now = $m_log->getDate();
    $m_log->tbl_name = $model->getTable();
    $m_log->tbl_id = !empty($id) ? $id : $model->id;
