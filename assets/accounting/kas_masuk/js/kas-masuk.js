var km = {
	...
	addForm: function() {
		$.get('accounting/KasMasuk/addForm',{
			},function(data){
			var _options = {
				className : 'veryWidth',
				message : data,
			...
			bootbox.dialog(_options).bind('shown.bs.modal', function(){
				...
				$(this).find("#TglMasuk").datetimepicker({
					locale: 'id',
					format: 'DD MMM Y'
				});
	...
	editForm: function(elm) {
		...
		$.get('accounting/KasMasuk/editForm',{
			'params': params
			},function(data){
			var _options = {
				className : 'veryWidth',
			...
			bootbox.dialog(_options).bind('shown.bs.modal', function(){
				...
				var tgl = $(this).find("#TglMasuk input").attr('data-tgl');
				$("#TglMasuk").data('DateTimePicker').date( moment(new Date((tgl))) );
	...
	save: function () {
		...
		var data = {
			'tanggal': dateSQL( $('#TglMasuk').data('DateTimePicker').date() ),
